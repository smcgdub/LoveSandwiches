...
def get_sales_data():
    ...
    """
    while True:
        print("\n1. Please enter sales data from the last market day.")
        print("2. Data should be six numbers separated by commas.")
        print("3. Example: 10,20,30,40,50,60\n")
        
        data_str = input("Enter your data here: ")
        #print(f"\nThe data you provided was {data_str}")
...
def validate_data(values):
    ...
    Raises a ValueError if strings cannot be converted into integers,
...
def update_worksheet(data, worksheet):    
    """
    Receives a list of integers to be inserted into a worksheest
...
#main()
sales_columns = get_last_5_entery_sales()